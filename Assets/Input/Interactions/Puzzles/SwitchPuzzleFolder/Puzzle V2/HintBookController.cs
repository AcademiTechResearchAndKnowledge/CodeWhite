...
public class HintBookController : MonoBehaviour
{
    ...
    public void OpenHintBook()
    {
        ...
        if (playerRefs != null)
        {
            // Turn off raycasting and wipe the UI prompt text clean
            if (playerRefs.interactionScript != null)
            {
                playerRefs.interactionScript.enabled = false;
            }
    ...
    public void CloseHintBook()
    {
        ...
        if (playerRefs != null)
        {
            // Re-enable interaction system for normal gameplay
            if (playerRefs.interactionScript != null)
            {
                playerRefs.interactionScript.enabled = true;
            }
